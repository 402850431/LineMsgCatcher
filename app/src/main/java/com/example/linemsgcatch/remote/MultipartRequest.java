...
public class MultipartRequest extends Request<String> {
    ...
    //新API使用 (添加header)
    public MultipartRequest(String url, Map<String, String> headerParam, Map<String, Object> params, Charset charSet, List<FileEntity> fileEntityList, Response.Listener<String> listener, Response.ErrorListener errorListener) {
        super(Method.POST, url, errorListener);
    ...
    //新API使用 (添加header)
    public MultipartRequest(String url, Map<String, String> headerParam, Map<String, Object> params, Charset charSet, FileEntity fileEntity, Response.Listener<String> listener, Response.ErrorListener errorListener) {
        super(Method.POST, url, errorListener);
        this.mHeaderParam = headerParam;
        this.mParams = params;
        this.mCharSet = charSet;
    ...
    //新API使用 (添加header)
    public MultipartRequest(String url, Map<String, String> headerParam, Map<String, Object> params, FileEntity fileEntity, Response.Listener<String> listener, Response.ErrorListener errorListener) {
        this(url, headerParam, params, Charset.defaultCharset(), fileEntity, listener, errorListener);
    }
